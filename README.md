...
<table>
  ...
  <tbody>
    ...
    <tr><td>Chat presence, typing, and live fan-out</td><td>Chat.join/leave, presence, committed reliable KIND_CHAT_EVENT fan-out, bounded resync, revocation cleanup, and typed mTLS cross-node delivery with leased fenced advertisements ship. Typing remains planned.</td><td>🚧</td></tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Chat presence, typing, and live fan-out</td><td>📋</td><td>📋</td><td>🚧</td><td>📋</td><td>Chat.join/leave, presence, committed reliable KIND_CHAT_EVENT fan-out, bounded resync, revocation cleanup, and typed mTLS cross-node delivery with leased fenced advertisements ship. Typing remains planned.</td></tr>
