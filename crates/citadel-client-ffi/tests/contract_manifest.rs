...
use citadel_wire::protocol::{
    ...
    KIND_TSYNC_V2_INPUT, KIND_TSYNC_V2_SNAPSHOT, MATCHMAKER_KIND_MAX, MATCHMAKER_KIND_MIN,
    NA_KIND_MAX, NA_KIND_MIN, NOTIFICATION_KIND_MAX, NOTIFICATION_KIND_MIN, POSITION_BYTES,
    REP_KIND_MAX, REP_KIND_MIN, ROOM_KIND_MAX, ROOM_KIND_MIN, RPC_METHOD_LEN_BYTES,
...
fn render_manifest() -> String {
    ...
    let manifest = serde_json::json!({
        ...
        "wire": {
            ...
            // Room policy rejection (kind 32, outside the pinned 21-25 range):
