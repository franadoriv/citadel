...
use citadel_wire::protocol::{
    ...
    CHAT_KIND_MIN, KIND_AUTH, KIND_AUTH_RESULT, KIND_CHAT_EVENT, KIND_DIAG_CAPABILITIES,
    KIND_DIAG_CLOCK_SYNC, KIND_DIAG_FLUSH, KIND_DIAG_SERVER_TIME, KIND_DIAG_START,
    KIND_DIAG_STATUS, KIND_MATCH_CLOSED, KIND_MATCH_INPUT, KIND_MATCH_INPUT_ACK,
    ...
    KIND_REP_DELTA, KIND_REP_SCHEMA, KIND_ROOM_CREATE, KIND_ROOM_JOIN, KIND_ROOM_JOINED,
    KIND_ROOM_LEAVE, KIND_ROOM_MAP_READY, KIND_ROOM_REJECT, KIND_RPC_REQUEST, KIND_RPC_RESPONSE,
    KIND_TSYNC_ACK, KIND_TSYNC_HELLO, KIND_TSYNC_INPUT, KIND_TSYNC_REWIND, KIND_TSYNC_ROLE,
    KIND_TSYNC_SNAPSHOT, KIND_TSYNC_V2_HELLO, KIND_TSYNC_V2_INPUT, KIND_TSYNC_V2_SNAPSHOT,
    MATCHMAKER_KIND_MAX, MATCHMAKER_KIND_MIN, NA_KIND_MAX, NA_KIND_MIN, NOTIFICATION_KIND_MAX,
    NOTIFICATION_KIND_MIN, POSITION_BYTES, REP_KIND_MAX, REP_KIND_MIN, ROOM_KIND_MAX,
    ROOM_KIND_MIN, RPC_METHOD_LEN_BYTES, RPC_REQUEST_ID_BYTES, RPC_STATUS_ERROR, RPC_STATUS_OK,
    SENDER_ID_BYTES, TSYNC_KIND_MAX, TSYNC_KIND_MIN,
};
...
fn render_manifest() -> String {
    ...
    let manifest = serde_json::json!({
        ...
        "wire": {
            ...
            "KIND_MATCH_INPUT": KIND_MATCH_INPUT,
            "KIND_MATCH_INPUT_ACK": KIND_MATCH_INPUT_ACK,
