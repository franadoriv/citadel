...
The JavaScript adapter does not yet support the friends host functions due to
limitations in the rquickjs binding. Calling `citadel.friends_add` will throw
an error "friends host not available". This is a known gap tracked in
and will be implemented when the binding supports better function registration.
:::
